let vid = document.getElementById('commlab-ending');
...
document.getElementById('commlab-ending').addEventListener("ended", toTransition);

function toTransition() {
  window.location.href = ("ending-credit.html");
}
